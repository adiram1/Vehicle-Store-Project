...
public class Motorcycle extends TwoWheels {
	...
	public Motorcycle(String licenseNum, String company, int year, int price, int numOfWheels, boolean isOffRoad,
			int maxSpeed, char licenseType, int engineCapacity) {
		super(licenseNum, company, year, price, numOfWheels, isOffRoad, maxSpeed);
